        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-8 mx-auto" >
                ...
                <p>
                    ...
                    <button type="submit" class="btn btn-primary my-2 cook"><i class="bi bi-basket3-fill"></i> Hazırla</button>
                </p>
            </div>
            </form>
        </div>
    ...
    $(document).ready(function () {
        ...
        $('.choose').click(function () {
            ...
            if ($(checkboxClass).prop('checked')) {
                ...
                ingre_arr.splice($.inArray(id, ingre_arr), 1);
